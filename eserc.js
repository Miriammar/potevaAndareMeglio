...
let searchedTitle = document.getElementById ('Title');
let searchedLocationMin = searchedLoc.value.toLowerCase ()
let searchedTitleMin = searchedTitleMin.value.toLowerCase ()

console.log(searchedLocationMin)
console.log(searchedJobMin)

for (const iterator of jobs){

    if title.location.toLowerCase().includes(searchedLocationMin, searchedTitleMin) && (location.title.toLowerCase().includes(queryTitolo.toLowerCase())) {
